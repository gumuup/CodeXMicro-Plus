...
- `CodeXMicro++-3.1.0-universal.dmg`：macOS 通用安装包，支持 Apple Silicon 与 Intel Mac。
...
- 鼠标中键、侧键和原始 HID 宏键也可直接录制；左右键必须搭配 Control、Option、Shift 或 Command，避免影响正常点击。部分鼠标宏键的显示名称会包含设备名称与宏键编号。
