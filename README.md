...
- `CodeXMicro++-2.5.0-universal.dmg`：macOS 通用安装包，支持 Apple Silicon 与 Intel Mac。
...
- **组合快捷键兼容**：单独轻点修饰键会映射修饰键本身，按住修饰键再按其他键则录入独占组合；冲突或被一级映射覆盖时会保留原绑定并标记未生效。
...
- 单独轻点并松开修饰键会映射修饰键本身；按住修饰键再按其他键则录入组合快捷键。组合键使用独占注册，若已被系统或其他应用独占，会拒绝新设置并保留原绑定。
